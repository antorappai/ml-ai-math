...
export const classicalMlLessons = [
  progressiveLesson({
    ...
    prerequisites: ["sampling-inference", "matrices-operations"],
  ...
  progressiveLesson({
    ...
    prerequisites: ["ml-workflow", "optimization-loss"],
  ...
  progressiveLesson({
    ...
    prerequisites: ["linear-regression-ml", "probability-events-bayes"],
  ...
  progressiveLesson({
    ...
    prerequisites: ["vectors-geometry", "ml-workflow"],
    tags: ["knn", "distance"],
  ...
  progressiveLesson({
    ...
    prerequisites: ["probability-events-bayes", "random-variables-distributions"],
  ...
  progressiveLesson({
    ...
    prerequisites: ["ml-workflow", "probability-events-bayes"],
  ...
  progressiveLesson({
    ...
    prerequisites: ["vectors-geometry", "optimization-loss", "logistic-classification"],
  ...
  progressiveLesson({
    ...
    prerequisites: ["vectors-geometry", "statistics-spread"],
  ...
  progressiveLesson({
    ...
    prerequisites: ["linear-regression-ml", "logistic-classification", "sampling-inference"],
